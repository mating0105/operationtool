...
export default {
  ...
  transformWGStoGCJ(wgLon, wgLat) {
    ...
    dLat =
      (dLat * 180) /
      ((6335552.7170004258 / (magic * sqrtMagic)) * 3.1415926535897931);
    dLon =
      (dLon * 180) /
      ((6378245 / sqrtMagic) * Math.cos(radLat) * 3.1415926535897931);
  ...
  transformLat(x, y) {
    var ret =
      ...
      2 * x +
      3 * y +
      0.20000000000000001 * y * y +
      0.10000000000000001 * x * y +
      0.20000000000000001 * Math.sqrt(Math.abs(x));
    ret +=
      ((20 * Math.sin(6 * x * 3.1415926535897931) +
        20 * Math.sin(2 * x * 3.1415926535897931)) *
        2) /
      3;
    ret +=
      ((20 * Math.sin(y * 3.1415926535897931) +
        40 * Math.sin((y / 3) * 3.1415926535897931)) *
        2) /
      3;
    ret +=
      ((160 * Math.sin((y / 12) * 3.1415926535897931) +
        320 * Math.sin((y * 3.1415926535897931) / 30)) *
        2) /
      3;
    return ret;
  },
  transformLon(x, y) {
    var ret =
      ...
      x +
      2 * y +
      0.10000000000000001 * x * x +
      0.10000000000000001 * x * y +
      0.10000000000000001 * Math.sqrt(Math.abs(x));
    ret +=
      ((20 * Math.sin(6 * x * 3.1415926535897931) +
        20 * Math.sin(2 * x * 3.1415926535897931)) *
        2) /
      3;
    ret +=
      ((20 * Math.sin(x * 3.1415926535897931) +
        40 * Math.sin((x / 3) * 3.1415926535897931)) *
        2) /
      3;
    ret +=
      ((150 * Math.sin((x / 12) * 3.1415926535897931) +
        300 * Math.sin((x / 30) * 3.1415926535897931)) *
        2) /
      3;
    return ret;
  },
